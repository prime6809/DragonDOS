...
; will do a JMP to $C002 to init the cartrage. The Dragon Alpha boot rom also looks for this
; as the first 2 characters of the loaded boot track. If found it flips the machine into
; map type 1. Then copies the loaded code up to $C000-$DFFF. Then copies the Basic ROM
; into ram in the normal place $8000-$BFFF, initializes basic, and then jumps to the DOS
; initialization at $C002.
